...
UProfileObject.prototype = {
    ...
    reset_password: function(sender){
        var form = jQuery(sender).closest('form');
        if (jQuery.FormCheck.validateForm(form[0])){
            this.post_form(form);
        }
    ...
    post_form: function(form_obj, success_callback){
        var self = this;
